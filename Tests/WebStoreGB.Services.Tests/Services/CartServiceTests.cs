...
namespace WebStoreGB.Services.Tests.Services
{
    [TestClass]
    public class CartServiceTests
    {
        ...
        public void Cart_Class_ItemsCount_returns_Correct_Quantity()
        {
            ...
            var expected_items_count = cart.Items.Sum(x => x.Quantity);
        ...
        public void CartViewModel_returns_Correct_ItemsCount()
        {
            ...
            var expected_items_count = cart_view_model.Items.Sum(x => x.Quantity);
        ...
        public void CartViewModel_returns_Correct_TotalPrice()
        {
            ...
            var expected_total_price = cart_view_model.Items.Sum(x => x.Quantity * x.Product.Price);
