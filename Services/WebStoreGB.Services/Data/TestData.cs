...
namespace WebStoreGB.Services.Data
{
    public static class TestData
    {
        public static List<Employee> Employees { get; } = new()
        {
            new Employee { Id = 1, FirstName = "Andrey", LastName = "Buba", Patronymic = "Bubovich", Age = 3 },
            new Employee { Id = 2, FirstName = "Uheg", LastName = "Ki", Patronymic = "Popovich", Age = 23 },
            new Employee { Id = 3, FirstName = "Рустам", LastName = "Абрамов", Patronymic = "Абрамович", Age = 55 }
        };
        ...
        public static IEnumerable<Section> Sections { get; } = new[]
        {
            ...
            new Section { Id = 10, Name = "Section3", Order = 2, ParentId = 7},
            ...
            new Section { Id = 15, Name = "Долче и Габбана", Order = 7, ParentId = 7},
        ...
        public static IEnumerable<Brand> Brands { get; } = new[]
        {
            ...
            new Brand{Id = 5, Name = "Addmolly", Order = 4},
